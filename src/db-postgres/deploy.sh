...
function main() {
    ...
    queue "funcs/media.get_place_cover_candidate.sql"
    ...
    queue "funcs/media.merge_places.sql"
    ...
    queue "funcs/media.set_place_cover.sql"
    queue "funcs/media.set_place_parent.sql"
